...
# ADK/LiteLLM necesita OPENAI_API_KEY en os.environ para autenticar; load_dotenv()
# ya lo deja en os.environ, pero lo re-aliasamos abajo explícitamente por claridad.
